...
export function ChatInterface() {
  ...
  const { messages, addMessage, isLoading, sendMessage, initializeChat } = useChatStore()
        ...
        {messages.length === 0 && (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <h3 className="text-lg font-semibold mb-2">Welcome to JuristAI</h3>
              <p className="text-muted-foreground">
                Ask me anything about Nigerian law, legal documents, or legal procedures.
              </p>
            </div>
          </div>
        )}
